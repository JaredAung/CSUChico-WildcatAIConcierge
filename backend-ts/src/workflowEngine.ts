import { WorkflowCard, WorkflowStep } from './models';

const WORKFLOWS: Record<string, WorkflowCard> = {
  facility_rental: {
...
export function getWorkflow(workflowType: string): WorkflowCard | null {
